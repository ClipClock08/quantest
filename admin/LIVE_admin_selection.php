			...
			<form name="adminClients" action="recrutement_db.php" method="post">
				...
				<div align="left">
					<fieldset><legend> Veracity of the information declared by the candidate </legend> 
    					<label>
        					<ol>
        						<li type="1">Identity:<input type="radio" value="1" name="identite" required> Ok<input type="radio" value="2" name="identite"> No<input type="radio" value="3" name="identite">No quite...
        						<li type="1">Civil status: <input type="radio" value="1" name="civil" required> Ok<input type="radio" value="2" name="civil"> No<input type="radio" value="3" name="civil">No quite...
        						<li type="1">Studies: <input type="radio" value="1" name="stuides" required> Ok<input type="radio" value="2" name="stuides"> No<input type="radio" value="3" name="stuides">No quite...
        						<li type="1">Professional experience: <input type="radio" value="1" name="experience" required> Ok<input type="radio" value="2" name="experience"> No<input type="radio" value="3" name="experience">No quite...
        					</ol>
    					</label>
				    </fieldset>
					<fieldset>
