                    ...
                    <fieldset>
                        ...
                        <table border="0" cellpadding="0" cellspacing="2" width="350">
                            <tr>
                                <td>1</td>
                                <td>Identity:</td>
                                <td width="35"><?php ?><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[15]);?>"
                                                                              width="16" height="16"
                                                                              border="0"></td>
                            ...
                            <tr>
                                <td>2</td>
                                <td>Civil status:</td>
                                <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[16]);?>" width="16" height="16" border="0">
                                </td>
                            ...
                            <tr>
                                <td>3</td>
                                <td>Studies:</td>
                                <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[17]);?>" width="16" height="16" border="0">
                                </td>
                            ...
                            <tr>
                                <td>4</td>
                                <td>Eperience:</td>
                                <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[18]);?>"
                                                                              width="16" height="16"
                                                                              border="0"></td>
                    ...
                    <fieldset>
                        ...
                        <table border="0" cellpadding="0" cellspacing="2">
                            <tr>
                                ...
                                <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[19]);?>" width="16" height="16" border="0">
                                </td>
                            ...
                            <tr>
                                ...
                                <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[20]);?>" width="16" height="16" border="0">
                                </td>
                            </tr>
                        </table>
                        <br>
        ...
        <fieldset>
            ...
            <table border="0" cellpadding="0" cellspacing="2">
                ...
                <tr>
                    ...
                    <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[25]);?>" width="16" height="16"
                                                                  border="0"></td>
                    <td width="450">
                        <div align="left">
                ...
                <tr>
                    ...
                    <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[26]);?>" width="16" height="16"
                                                                  border="0"></td>
                    <td width="450">
                        <div align="left">
                ...
                <tr>
                    ...
                    <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[27]);?>" width="16" height="16"
                                                                  border="0"></td>
                    <td width="450">
                        <div align="left">
                ...
                <tr>
                    ...
                    <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[28]);?>" width="16" height="16"
                                                                  border="0"></td>
                    <td width="450">
                        <div align="left">
                ...
                <tr>
                    ...
                    <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[29]);?>" width="16" height="16"
                                                                  border="0"></td>
                    <td width="450">
                        <div align="left">
                ...
                <tr>
                    ...
                    <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[30]);?>" width="16" height="16"
                                                                  border="0"></td>
                    <td width="450">
                        <div align="left">
                ...
                <tr>
                    ...
                    <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[31]);?>" width="16" height="16"
                                                                  border="0"></td>
                    <td width="450">
                        <div align="left">
                ...
                <tr>
                    ...
                    <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[32]);?>" width="16" height="16"
                                                                  border="0"></td>
                    <td width="450">
                        <div align="left">
                ...
                <tr>
                    ...
                    <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[33]);?>" width="16" height="16"
                                                                  border="0"></td>
                    <td width="450">
                        <div align="left">
                ...
                <tr>
                    ...
                    <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[34]);?>" width="16" height="16"
                                                                  border="0"></td>
                    <td width="450">
                        <div align="left">
                ...
                <tr>
                    ...
                    <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[35]);?>" width="16" height="16"
                                                                  border="0"></td>
                    <td width="450">
                        <div align="left">
                ...
                <tr>
                    ...
                    <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[36]);?>" width="16" height="16"
                                                                  border="0"></td>
                    <td width="450">
                        <div align="left">
                ...
                <tr>
                    ...
                    <td width="35"><img src="../GROUPE/html-test-result/img/<?php echo getImages($selection_arr[37]);?>" width="16" height="16"
                                                                  border="0"></td>
                    <td width="450">
                        <div align="left">
