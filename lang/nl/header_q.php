			...
			<div align="right">
				...
				<?php
                            ...
                            if(!isset($_SESSION['email']) && !isset($_SESSION['password'])){
                                ...
                                ?>
									<a href="https://quantest.eu/lang/nl/form_register.php">Registreren</a> |
									 <a href="https://quantest.eu/lang/nl/form_auth.php">Inloggen</a>
                                <?php
                            }else{
                               //If the user is authorized, then output the link Logout
                                ?>
                                <a href="https://quantest.eu/lang/nl/logout.php">Log out</a> | 
								<a href="https://quantest.eu/lang/nl/profile.php"><?php echo $name ." ". $surName;?></a>
                                <?php
                            }
                        ?>
			...
			<div id="bloc_page">
                ...
                <div id="titre_principal">
					...
					<div id="h2">
                         ...
                         <h2>Beste HR-Assistent <br/>voor Succesvolle Recruiters! </h2>   
                    </div>
