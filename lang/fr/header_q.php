		...
		<div id="bloc_page">
			...
			<?php
                            ...
                            if(!isset($_SESSION['email']) && !isset($_SESSION['password'])){
                                ...
                                ?>
                                 <a href="https://quantest.eu/lang/fr/form_register.php">Enregistrement</a> | <a href="https://quantest.eu/lang/fr/form_auth.php">Connexion</a>   
                                <?php
                            }else{
                                //If the user is authorized, then output the link Logout
                                ?><a href="https://quantest.eu/lang/fr/profile.php">Bonjour <b><?php echo $name ." ". $surName;?></b></a> | <a href="https://quantest.eu/lang/fr/logout.php">D&eacute;connexion</a>
			...
			<div id="bloc_page">
                ...
                <div id="titre_principal">
                    <div id="logo">
                       <a href="https://quantest.eu/indexFR.php">
                            <img src="https://quantest.eu/img/logoQuantestPlat.jpg" alt="Logo Quantest" />
                       </a>
                    </div>
					<div id="h2">
                        
                         <h2>Meilleur Assistant RH<br/> pour Recruteurs de Succ&egrave;s!</h2>   
                    </div>
                ...
                <nav>
                    <ul>
                       <li><a href="https://quantest.eu/lang/fr/config/expert_config.php">RECRUTEMENT</a></li>  
					   <li><a href="https://quantest.eu/lang/fr/reconversion_form.php">RECONVERSION</a></li> 
					   <li><a href="https://quantest.eu/lang/fr/quotation_form.php"><b>Calculer et commander</b></a></li>
