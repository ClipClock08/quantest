...
<div id="form_auth">
    <p><h1>Se connecter &agrave; l'interface Quantest</h1></p>
    ...
    <form action="auth.php" method="post">
        <table border="0" cellpadding="2" cellspacing="2" width="400">
            <tr>
                <td>
                    <fieldset>
                        <legend> Veuillez vous connecter ou vous <a href="form_register.php">enregistrer </a></legend>
                        <table border="0" cellpadding="0" cellspacing="2" whidt="600">
                           ...
                           <br> <tr>
                                ...
                                <td width="342"><input type="text" name="email" placeholder="votre adresse email.." size="24"></td>
                            </tr>
                            <tr>
                                <td width="241">
                                    <div align="left">
                            ...
                            <tr>
                                <td valign="top" colspan="2">
                                    <p><a href="recovery_pass.php"><font size="2">J'ai oubli&eacute; mon mot de passe</font></a></p>
                                </td>
                            </tr>
                            </tbody>
                        </table>
...
?>
    <div id="authorized">
        <h2>Vous &ecirc;tes d&eacute;j&agrave; connect&eacute;!</h2>
    </div>
