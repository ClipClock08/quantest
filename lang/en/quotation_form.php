	...
	<tbody>
		<tr>
			...
			<td>Net <b>PRICE</b> <input type="text" name="textfieldName" size="4"> <br>
				<br> <button class="button">Order now!</button></td>
		</tr>
		</form>
	</tbody>
</table>
...
<table border="0" width="700" cellspacing="2" cellpadding="2" id="add_job">
	...
	<tbody>
		<tr>
						...
						<tbody>
							<tr>
								<td valign="top" width="318">
									<div align="left">
										Collaborator(s) to reclassify:</div>
								</td>
								<td width="107"><input type="text" placeholder="1,2,3,.." id="nbCandidates" name="specification_cap" size="4"></td>
							</tr>
							<tr>
								<td valign="top" width="318">
									<div align="left">
										Reclassification options:</div>
								</td>
								<td width="107"><input type="text" placeholder="1,2,3,.." id="nbCandidates" name="specification_cap" size="4"></td>
							</tr>
						</tbody>
			...
			<td>Net <b>PRICE</b> <input type="text" name="textfieldName" size="4"><br>
				<br>
				<button class="button">Order now!</button></td>
			</td>
		</tr>
		</form>
	</tbody>
