    ...
    <table border="0" cellpadding="5" cellspacing="2" width="631">
        <tr>
            <td valign="top" align="left" colspan="2">
                ...
                <h1><img src="<?php echo $address_site; ?>/img/testType.jpg" border="0"
                         alt="Standardized Quantest Recruitment Criteria"><strong>Recruitment test</strong>, set up your
                    test.</h1>
                <h2>The requirements of the function are determined by the QUANTEST expert system. Click on the
                    magnifying glass and discover the criteria tested on your candidates.</h2>

                <p>
                    <form name="exigences" action="expert_config_db.php" method="post">
                        <div align="left">
                            <fieldset>
                                <legend><b>Identification of the function to be filled</b></legend>
                <p><label for="service">Name of the function:
                        <input type="text" id="service" name="service" placeholder="type the name..." required
                               size="39">
                    </label><br/>
                <p><label for="service">Service:
                        <select name="fonction" id="fonction">
                            ...
                            <option value="9">Office of studies/ R&D</option>
                            <option value="10">Other service? Specify =></option>
                        </select>

                        <input type="text" id="service" name="other_service" placeholder="specify the service..."
                               size="30">
                    </label></p>
