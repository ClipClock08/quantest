...
<h1><img src="<?php echo $address_site; ?>/img/testType.jpg" border="0"
         alt="Standardized Quantest Reconversion Criteria">Test for a professional reconversion</h1><h2>Introduce the
    generalities of the possible functions for the available
    collaborator</h2>
<form action="reconversion.php" method="post" name="exigences">
                    ...
                    <fieldset>
                        ...
                        <table border="0" cellspacing="2" cellpadding="0">
                            ...
                            <tr>
                                ...
                                <td valign="bottom" width="437"><input name="service_name[1]" size="50" type="text">
                                </td>
                            </tr>
                            <tr>
                                <td valign="middle" width="241">
            ...
            <fieldset>
                ...
                <table border="0" cellspacing="2" cellpadding="0">
                    ...
                    <tr>
                        ...
                        <td valign="top" width="437"><input name="reclass_fisrt_name" size="24" type="text" required>
                        </td>
                    </tr>
                    <tr>
                        <td valign="middle" width="241">
    ...
    By clicking "Save" the abilities of this collaborator will be tested according to the requirements of the indicated
    optional positions.<br>The result of the test, in agreement with your order, will be visible on your personal page
    (profile).
    <p><?php
