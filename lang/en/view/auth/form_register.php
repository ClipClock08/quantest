...
if ((!isset($_SESSION["email"]) && !isset($_SESSION["password"]))) {
    ...
    if (!isset($_GET["hidden_form"])) {
        ...
        <div id="form_register">
            <p>
            <h1>Registering on the Quantest interface</h1></p>
            ...
            <form action="register.php" method="post" name="form_register">
                <fieldset>
                    ...
                    <table border="0" cellpadding="0" cellspacing="2" whidt="600">
                        ...
                        <tr>
                            <td width="277">VAT*:</td>
                            <td width="401"><input type="text" name="vat" size="50" required></td>
                        </tr>
                        <tr>
                            <td width="277">Civility*:</td>
                            <td width="401">
                                <input type="radio" value="Mr" name="civilitye" required> Mr<input type="radio"
                                                                                                   value="Mrs"
                                                                                                   name="civilitye"
                                                                                                   required> Mrs<input
                                        type="radio" value="Miss" name="civilitye" required>Miss
                            </td>
                        </tr>
                        <tr>
                        ...
                        <tr>
                            <td colspan="2"><br>
                                <input type="checkbox" value="checkboxValue" name="sales"> I understood and accept the
                                <a href="../layouts/terms_of_sale.php">General conditions of sale</a>*<br>
                                <input type="checkbox" value="checkboxValue" name="privacy"> I understood and accept the
                                Quantest <a href="../layouts/confidentiality.php">Privacy Policy</a>*
                            </td>
                        </tr>
                        <tr>
                            <td><br>
