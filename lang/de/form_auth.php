...
<div id="form_auth">
    <p><h1>Verbindung zur Quantest-Schnittstelle</h1></p>
    ...
    <form action="auth.php" method="post">
        <table border="0" cellpadding="2" cellspacing="2" width="400">
            <tr>
                <td>
                    <fieldset>
                        <legend> Bitte einloggen oder <a href="form_register.php">registrieren </a></legend><br>
                        <table border="0" cellpadding="0" cellspacing="2" whidt="600">
                           ...
                           <tr>
                                ...
                                <td width="342"><input type="text" name="email" placeholder="ihre e-mail-adresse.." size="24"></td>
                            </tr>
                            <tr>
                                <td width="241">
                                    <div align="left">
                            ...
                            <tr>
                                <td valign="top" colspan="2">
                                    <p><a href="recovery_pass.php"><font size="2">Ich habe mein Passwort vergessen..</font></a></p>
                                </td>
                            </tr>
                            </tbody>
                        </table>
