...
<div align="center">
			...
			<form name="adminClients" action="selection_db.php" method="post">
				<fieldset>
					<legend>Encoding the values of a job selection test </legend> <label for="nomPoste">Client name: <input type="text" id="nomClient" class="autocomplete" name="nomClient" placeholder="select the client from the list"> </label> <label for="nomTest">
					    Test of selected client: <select name="typeOfTest" >
    	...
    	<script>
		    $( "#nomClient" ).change(function() {
				...
				<div align="left">
					<fieldset><legend> Veracity of the information declared by the candidate </legend> 
    					<label>
        					<ol>
        						<li type="1">Identity:<input type="radio" value="1" name="identite"> Ok<input type="radio" value="2" name="identite"> No<input type="radio" value="3" name="identite">No quite...
        						<li type="1">Civil status: <input type="radio" value="1" name="civil"> Ok<input type="radio" value="2" name="civil"> No<input type="radio" value="3" name="civil">No quite...
        						<li type="1">Studies: <input type="radio" value="1" name="stuides"> Ok<input type="radio" value="2" name="stuides"> No<input type="radio" value="3" name="stuides">No quite...
        						<li type="1">Professional experience: <input type="radio" value="1" name="experience"> Ok<input type="radio" value="2" name="experience"> No<input type="radio" value="3" name="experience">No quite...
        					</ol>
    					</label>
				    </fieldset>
					<fieldset>
					...
					<fieldset>
						...
						<ol>
							...
							<li type="1">Psychological state: <select name="psycho_state" width="45" size="1">
									<option value="1">select..</option>
							...
							<li type="1">Free of addictions (alcohol,..): <select name="alcohol" width="45" size="1">
									<option value="1">select..</option>
					...
					<fieldset>
						...
						<ol>
							<li type="1"> Studies and and experience to assume this function: <select name="summary_exp" width="45" size="1">
									<option value="1">select..</option>
							...
							<li type="1"> Naturalness in safety matter: <br><select name="safety" width="45" size="1">
									<option value="1">select..</option>
								...
								<li type="1"> Quality of his/ her work in this function: <select name="quality" width="45" size="1">
									<option value="1">select..</option>
								...
								<li type="1"> Natural sense of organization: <select name="organization" width="45" size="1">
									<option value="1">select..</option>
								...
								<li type="1"> Naturalness in terms of work rate: <select name="terms_of_work" width="45" size="1">
									<option value="1">select..</option>
								...
								<li type="1"> Naturalness in responsibilities: <select name="responsibilities" width="45" size="1">
									<option value="1">select..</option>
								...
								<li type="1"> Naturalness for initiative: <select name="initiative" width="45" size="1">
									<option value="1">select..</option>
								...
								<li type="1"> Naturalness in social behavior: <select name="social_behavior" width="45" size="1">
									<option value="1">select..</option>
								...
								<li type="1"> Motivation and interest in investing in this function: <select name="motivation" width="45" size="1">
									<option value="1">select..</option>
								...
								<li type="1"> Naturalness in terms of professional availability: <select name="professional_availability" width="45" size="1">
									<option value="1">select..</option>
								...
								<li type="1"> Naturalness in attendance and punctuality at work: <select name="attendance_and_punctuality" width="45" size="1">
									<option value="1">select..</option>
								...
								<li type="1"> Natural aptitude for training: <select name="training" width="45" size="1">
									<option value="1">select..</option>
							...
							<li type="1"> Natural ability for command: <select name="command" width="45" size="1">
									<option value="1">select..</option>
