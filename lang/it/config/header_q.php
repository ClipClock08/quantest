...
$path = $_SERVER['SCRIPT_URL'];
    ...
    if($path == "/" || $path == "/indexIT.php"){
       ...
       $pathIt = "https://quantest.eu".$path;
        //clear the result: $path<hr />\n";
		...
		<div id="bloc_page">
			<div align="right">
				...
				<?php
                            ...
                            if(!isset($_SESSION['email']) && !isset($_SESSION['password'])){
                                ...
                                ?>
                                 <a href="https://quantest.eu/lang/it/form_register.php">Registrati</a> | <a href="https://quantest.eu/lang/it/form_auth.php">Accedi</a>   
                                <?php
                            }else{
                                //If the user is authorized, then output the link Logout
                                ?><a href="https://quantest.eu/lang/it/profile.php">Ciao! <a href="img/profile.png"><img src="../img/profile.png"></a> <b><?php echo $name ." ". $surName;?></b></a> | <a href="https://quantest.eu/lang/it/logout.php">Esci</a>
			...
			<div id="bloc_page">
                ...
                <div id="titre_principal">
                    <div id="logo">
                        <a href="https://quantest.eu/indexIT.php">
                            <img src="https://quantest.eu/img/logoQuantestPlat.jpg" alt="Logo Quantest" />
                        </a>
                    </div>
					<div id="h2">
                        
                        <h2>Miglior Assistente HR
<br>per Reclutatori di Successo!</h2>    
                    </div>
                ...
                <nav>
                    <ul>
                       <li><a href="https://quantest.eu/lang/it/config/expert_config.php">RECLUTAMENTO</a></li>
                        <li><a href="https://quantest.eu/lang/it/reconversion_form.php">RIQUALIFICAZIONE</a></li> 
						<li><a href="https:///quantest.eu/lang/it/quotation_form.php"><b>Calcola e Ordina</b></a></li>
