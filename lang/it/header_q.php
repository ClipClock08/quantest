			...
			<div align="right">
				...
				<?php
                            ...
                            if(!isset($_SESSION['email']) && !isset($_SESSION['password'])){
                                ...
                                ?><a href="profile.php">Ciao! <a href="img/profile.png"><img src="img/profile.png"></a> <b><?php echo $name ." ". $surName;?></b></a> | <a href="logout.php">Esci</a>
			...
			<div id="bloc_page">
                ...
                <div id="titre_principal">
					...
					<div id="h2">
                         ...
                         <h2>Miglior Assistente HR<br/> per Reclutatori di Successo!</h2>  
                    </div>
