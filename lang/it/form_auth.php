...
<div id="form_auth">
   <p> <h1>Connettiti con l'interfaccia Quantest</h1></p>
    ...
    <form action="auth.php" method="post">
        <table border="0" cellpadding="2" cellspacing="2" width="400">
            <tr>
                <td>
                    <fieldset>
                        <legend> Connettiti o <a href="form_register.php">registrati </a> </legend><br>
                        <table border="0" cellpadding="0" cellspacing="2" whidt="600">
                            ...
                            <tr>
                                ...
                                <td width="342"><input type="text" name="email" placeholder="inserisci la tua email.." size="24"></td>
                            </tr>
                            <tr>
                                <td width="241">
                                    <div align="left">
                            ...
                            <tr>
                                <td valign="top" colspan="2">
                                    <p><a href="recovery_pass.php"><font size="2">Ho dimenticato la mia password..</font></a></p>
                                </td>
                            </tr>
                            </tbody>
                        </table>
