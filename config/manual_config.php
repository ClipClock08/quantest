        ...
        <tr>
            <td valign="top" align="left" colspan="2">
                <div align="center">
                    ...
                    <form name="exigences" action="candidates.php" method="post">
                        <div align="left">
                            <fieldset>
                            ...
                            <fieldset>
                                ...
                                <label for="horaire">Work timetable:
                            ...
                            <fieldset>
                                ...
                                <div align="center">
                                    <table border="0" cellpadding="2" cellspacing="4">
                                        <tr>
                                            <td><label class="container">Alone<input type="checkbox"> <span
                                                            class="checkmark"></span></label> <label class="container">As
                                                    a team<input type="checkbox"> <span
                                                            class="checkmark"></span></label> <label
                                                        class="container"><input type="checkbox"> <span
                                                            class="checkmark"></span></label> <label
                                                        class="container"><input type="checkbox"> <span
                                                            class="checkmark"></span></label> <label class="container">With
                                                    subordinates <input type="checkbox"> <span class="checkmark"></span></label>
                                            </td>
                                            <td><label class="container">With women <input type="checkbox"> <span
                                                            class="checkmark"></span></label><label class="container">With
                                                    mens <input type="checkbox"> <span class="checkmark"></span></label><label
                                                        class="container">With colleagues <input type="checkbox"> <span
                                                            class="checkmark"></span></label></td>
                                            <td><label class="container">With customers <input type="checkbox"> <span
                                                            class="checkmark"></span></label><label class="container">With
                                                    superiors <input type="checkbox"> <span
                                                            class="checkmark"></span></label><label class="container">In
                                                    the crowds <input type="checkbox"> <span
                                                            class="checkmark"></span></label></td>
                                        </tr>
                                    </table>
                                </div>
                            ...
                            <fieldset>
                                ...
                                <div align="left">
                                    <label for="bruit">Noise: <select name="horaire" id="bruit">
                                        ...
                                        </select></label> <label for="temperature">Temperature: <select
                                                name="temperature">
                                            <option value="1">select...</option>
                                    ...
                                    <p><input type="text" id="odeurs" name="specification"
                                              placeholder="specify which odors.."></legend></p>
                                </div>
                            </fieldset>
                            ...
                            <fieldset>
                                ...
                                <div align="center">
                                    <table border="0" cellpadding="2" cellspacing="4">
                                        <tr>
                                            <td><label class="container">Manual ability <input type="checkbox"> <span
                                                            class="checkmark"></span></label><label class="container">Reaction
                                                    speed <input type="checkbox"> <span
                                                            class="checkmark"></span></label><label class="container">Stress
                                                    resistance <input type="checkbox"> <span
                                                            class="checkmark"></span></label></td>
                                            <td><label class="container">Creativity<input type="checkbox"> <span
                                                            class="checkmark"></span></label> <label class="container">Discernment<input
                                                            type="checkbox"> <span
                                                            class="checkmark"></span></label> </label><label
                                                        class="container">Perseverance<input type="checkbox"> <span
                                                            class="checkmark"></span></label></td>
                                            <td><label class="container">Enthusiasm<input type="checkbox"> <span
                                                            class="checkmark"></span></label><label class="container">Logic<input
                                                            type="checkbox"> <span
                                                            class="checkmark"></span></label><label class="container">Realism<input
                            ...
                            <input name="candidates.php" value="Continue" type="submit"></div>
                    </form>
                </div>
            </td>
            <td valign="top">
